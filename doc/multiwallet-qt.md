...
In order to support loading of multiple wallets in dashplatinum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dashplatinum.cpp.
...
Changes to dashplatinum.cpp
----------------------
dashplatinum.cpp is the entry point into dashplatinum-qt, and as such, will require some minor modifications to provide hooks for
