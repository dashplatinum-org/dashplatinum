...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DashPlatinum features */
        {"dashplatinum", "masternode", &masternode, true, true, false},
        {"dashplatinum", "listmasternodes", &listmasternodes, true, true, false},
        {"dashplatinum", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dashplatinum", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dashplatinum", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dashplatinum", "masternodedebug", &masternodedebug, true, true, false},
        {"dashplatinum", "startmasternode", &startmasternode, true, true, false},
        {"dashplatinum", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dashplatinum", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dashplatinum", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dashplatinum", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dashplatinum", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dashplatinum", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dashplatinum", "mnbudget", &mnbudget, true, true, false},
        {"dashplatinum", "preparebudget", &preparebudget, true, true, false},
        {"dashplatinum", "submitbudget", &submitbudget, true, true, false},
        {"dashplatinum", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dashplatinum", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dashplatinum", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dashplatinum", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dashplatinum", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dashplatinum", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dashplatinum", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dashplatinum", "checkbudgets", &checkbudgets, true, true, false},
        {"dashplatinum", "mnsync", &mnsync, true, true, false},
        {"dashplatinum", "spork", &spork, true, true, false},
        {"dashplatinum", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dashplatinum", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dashplatinumd, or the -server option to dashplatinum-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dashplatinum-cli " + methodname + " " + args + "\n";
}
