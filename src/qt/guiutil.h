...
/** Utility functions used by the DASHP Qt UI.
 */
namespace GUIUtil
{
...
// Render DASHP addresses in monospace font
...
// Parse "dashplatinum:" URI into recipient object, return true on successful parsing
