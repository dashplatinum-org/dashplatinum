                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DashPlatinum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DASHP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dashplatinum: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DASHP Core"), this);
    aboutAction->setStatusTip(tr("Show information about DASHP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DASHP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DASHP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DASHP addresses"));
    ...
    openAction->setStatusTip(tr("Open a DASHP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DASHP Core help message to get a list with possible DASHP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DASHP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DASHP network", "", count));
}
...
{
    QString strTitle = tr("DASHP Core"); // default title
