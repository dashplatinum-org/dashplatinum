...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DashPlatinum Core dashplatinum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dashplatinum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dashplatinum transaction") + "\n" +
                               "  dashplatinum-tx [options] -create [commands]   " + _("Create hex-encoded dashplatinum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dashplatinum transaction
